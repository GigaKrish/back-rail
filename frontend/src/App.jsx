        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, alignItems: 'flex-end' }}>
          ...
          <div className="map-legend">
            <div className="legend-item">
              <div className="legend-dot" style={{ width: 16, height: 16, background: 'transparent', border: '1.5px dashed var(--gold)', borderRadius: '50%' }} />
              Shared CAD-Drawing
            </div>
            {CAMERA_TYPES.map(type => {
              const cfg = CAM_CONFIG[type];
              return (
                <div key={type} className="legend-item" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <svg width="14" height="14" viewBox="0 0 16 16" style={{ filter: `drop-shadow(0px 1px 1px ${cfg.color}80)` }}>
